...
namespace Task6
{
    class Fraesmaschine : IWerkzeugmaschine
    {
        // Private members
        private int _id;
        ...
        public string WerkzeugLangsamAufruesten(int MagazinPlatz, string Werkzeug)
        {
            ...
            return $"Fraesmaschine {ID} wird LANGSAM mit {_werkzeugMagazin[MagazinPlatz]} bestueckt.";
        }
        ...
        public string WerkstueckLangsamBearbeiten()
        {
            ...
            System.Threading.Thread.Sleep(1000 + ((new Random()).Next(1000)));
            return $"Werkstück wird LANGSAM mit {_werkzeugMagazin[AktivesWerkzeug]} gefraest.";
        }
    }
}
